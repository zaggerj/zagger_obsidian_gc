...
Author:: zagger
Source URL::
Modify:: 2023-12-20 星期三 09:43:56
...
![image.png](https://raw.githubusercontent.com/zaggerj/obsidian_picgo/main/obsidian/20231220094520.png)
当文档滚动了：

- `pageY` —— 元素在文档中的相对坐标保持不变，从文档顶部（现在已滚动出去）开始计算。
- `clientY` —— 窗口相对坐标确实发生了变化（箭头变短了），因为同一个点越来越靠近窗口顶部。

### 1.4.2. [元素坐标：getBoundingClientRect](https://zh.javascript.info/coordinates#yuan-su-zuo-biao-getboundingclientrect)

<mark style="background: #FF5582A6;">小结：获取元素的坐标，相对于窗口的坐标，加上滚动距离，就是相对于文档的坐标。</mark>
...
例如，点击下面这个按钮以查看其窗口坐标：
![image.png](https://raw.githubusercontent.com/zaggerj/obsidian_picgo/main/obsidian/20231220095829.png)

如果你滚动此页面并重复点击上面那个按钮，你会发现随着窗口相对按钮位置的改变，其窗口坐标（如果你垂直滚动页面，则为 `y/top/bottom`）也随之改变。

下面这张是 `elem.getBoundingClientRect()` 的输出的示意图：
![image.png](https://raw.githubusercontent.com/zaggerj/obsidian_picgo/main/obsidian/20231220095813.png)
...
![image.png](https://raw.githubusercontent.com/zaggerj/obsidian_picgo/main/obsidian/20231220100150.png)
...
### 1.4.3. [elementFromPoint(x, y)](https://zh.javascript.info/coordinates#elementFromPoint)

<mark style="background: #FF5582A6;">小结：用来在指定坐标找元素。</mark>
...
### 1.4.4. [用于 “fixed” 定位](https://zh.javascript.info/coordinates#yong-yu-fixed-ding-wei)

<mark style="background: #FF5582A6;">小结：fixed相对于窗口。</mark>
...
![image.png](https://raw.githubusercontent.com/zaggerj/obsidian_picgo/main/obsidian/20231220101517.png)
...
### 1.4.5. [文档坐标](https://zh.javascript.info/coordinates#getCoords)

<mark style="background: #FF5582A6;">小结：absolute，文档坐标</mark>
...
```
### 1.4.6. [总结](https://zh.javascript.info/coordinates#zong-jie)
