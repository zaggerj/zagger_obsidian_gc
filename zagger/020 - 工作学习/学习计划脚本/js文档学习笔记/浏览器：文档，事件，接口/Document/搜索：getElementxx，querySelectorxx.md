...
# 1. 搜索：getElementxx，querySelectorxx
...
Author:: zagger
Source URL::
Modify:: 2023-12-19 星期二 12:51:24
...
### 1.4.1. 搜索：getElement*，querySelector*

**小结：当不清楚元素范围或者元素离得比较远，则需要搜索**

当元素彼此靠得近时，DOM 导航属性（navigation property）非常有用。如果不是，那该怎么办？如何去获取页面上的任意元素？

还有其他搜索方法。 

### 1.4.2. [document.getElementById 或者只使用 id](https://zh.javascript.info/searching-elements-dom#documentgetelementbyid-huo-zhe-zhi-shi-yong-id)
...
### 1.4.3. [querySelectorAll](https://zh.javascript.info/searching-elements-dom#querySelectorAll)
...
![image.png](https://raw.githubusercontent.com/zaggerj/obsidian_picgo/main/obsidian/20231219141244.png)

### 1.4.4. [querySelector](https://zh.javascript.info/searching-elements-dom#querySelector)

`elem.querySelector(css)` 调用会返回给定 CSS 选择器的第一个元素。

换句话说，结果与 `elem.querySelectorAll(css)[0]` 相同，
但是后者会查找 **所有** 元素，并从中选取一个，而 `elem.querySelector` 只会查找一个。
因此它在**速度上更快，并且写起来更短**。

### 1.4.5. [matches](https://zh.javascript.info/searching-elements-dom#matches)
...
### 1.4.6. [closest](https://zh.javascript.info/searching-elements-dom#closest)
...
### 1.4.7. [getElementsBy*](https://zh.javascript.info/searching-elements-dom#getelementsby)
...
### 1.4.8. [实时的集合](https://zh.javascript.info/searching-elements-dom#shi-shi-de-ji-he)
<mark style="background: #FF5582A6;">小结</mark>：`"getElementsBy*"`是实时集合，相反，`querySelectorAll` 返回的是一个 **静态的** 集合。思考一下如何实现的？


所有的 `"getElementsBy*"` 方法都会返回一个 **实时的（live）** 集合。
这样的集合始终反映的是文档的当前状态，并且在文档发生更改时会“自动更新”。
...
### 1.4.9. [总结](https://zh.javascript.info/searching-elements-dom#zong-jie)
