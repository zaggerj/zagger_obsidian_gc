...
Author:: zagger
Source URL::
Modify:: 2023-12-19 星期二 18:01:42
...
### 1.4.2. [className 和 classList](https://zh.javascript.info/styles-and-classes#classname-he-classlist)
<mark style="background: #FF5582A6;">小结：className，是html特性，代表样式类字符串，只能整个修改；classList是样式类可迭代对象属性，拥有一系列方法，进行操作。</mark>
...
### 1.4.3. [元素样式](https://zh.javascript.info/styles-and-classes#yuan-su-yang-shi)
<mark style="background: #FF5582A6;">小结：style本身是只读的，但是style对象属性可写，对应html中style特性字符串。操作对象属性时，使用驼峰命名属性。</mark>
...
### 1.4.4. [重置样式属性](https://zh.javascript.info/styles-and-classes#zhong-zhi-yang-shi-shu-xing)
小结：style.cssText操作的style对应的特性，跟`div.setAttribute('style', 'color: red...')`效果一样； `elem.style.removeProperty('style property')`可以删除style部分属性。
...
### 1.4.5. [注意单位](https://zh.javascript.info/styles-and-classes#zhu-yi-dan-wei)
<mark style="background: #FF5582A6;">小结：单位要加上px。</mark>
...
### 1.4.6. [计算样式：getComputedStyle](https://zh.javascript.info/styles-and-classes#ji-suan-yang-shi-getcomputedstyle)
...
### 1.4.7. [总结](https://zh.javascript.info/styles-and-classes#zong-jie)
