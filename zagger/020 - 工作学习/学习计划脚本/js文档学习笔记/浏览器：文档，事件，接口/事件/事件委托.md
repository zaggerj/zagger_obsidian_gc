...
这个想法是，如果我们**有许多以类似方式处理的元素**，那么就不必为每个元素分配一个处理程序 —— 而是**将单个处理程序放在它们的共同祖先上**。
...
![image.png](https://raw.githubusercontent.com/zaggerj/obsidian_picgo/main/obsidian/20231220145209.png)
...
### 1.4.2. [委托示例：标记中的行为](https://zh.javascript.info/event-delegation#wei-tuo-shi-li-biao-ji-zhong-de-hang-wei)
...
### 1.4.3. [“行为”模式](https://zh.javascript.info/event-delegation#hang-wei-mo-shi)
...
#### 1.4.3.1. [行为：计数器](https://zh.javascript.info/event-delegation#hang-wei-ji-shu-qi)
...
#### 1.4.3.2. [行为：切换器](https://zh.javascript.info/event-delegation#hang-wei-qie-huan-qi)
...
### 1.4.4. [总结](https://zh.javascript.info/event-delegation#zong-jie)
