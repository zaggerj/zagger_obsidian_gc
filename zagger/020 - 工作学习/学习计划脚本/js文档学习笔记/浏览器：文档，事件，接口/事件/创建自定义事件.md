...
Author:: zagger
Source URL::
Modify:: 2023-12-20 星期三 16:06:02
...
### 1.4.2. [事件构造器](https://zh.javascript.info/dispatch-events#shi-jian-gou-zao-qi)
...
### 1.4.3. [dispatchEvent](https://zh.javascript.info/dispatch-events#dispatchevent)
...
### 1.4.4. [冒泡示例](https://zh.javascript.info/dispatch-events#mao-pao-shi-li)
...
### 1.4.5. [MouseEvent，KeyboardEvent 及其他](https://zh.javascript.info/dispatch-events#mouseeventkeyboardevent-ji-qi-ta)
...
### 1.4.6. [自定义事件](https://zh.javascript.info/dispatch-events#zi-ding-yi-shi-jian)
...
### 1.4.7. [event.preventDefault()](https://zh.javascript.info/dispatch-events#eventpreventdefault)
...
### 1.4.8. [事件中的事件是同步的](https://zh.javascript.info/dispatch-events#shi-jian-zhong-de-shi-jian-shi-tong-bu-de)
...
### 1.4.9. [总结](https://zh.javascript.info/dispatch-events#zong-jie)
