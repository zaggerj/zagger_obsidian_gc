...
### 1.5.6. [对象处理程序：handleEvent](https://zh.javascript.info/introduction-browser-events#dui-xiang-chu-li-cheng-xu-handleevent)
...
### 1.5.7. [总结](https://zh.javascript.info/introduction-browser-events#zong-jie)
