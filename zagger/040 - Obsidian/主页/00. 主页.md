...
status: 进行中
target: 10000
banner: "040 - Obsidian/附件/banners/rainy-day-bird-2.gif"
banner_icon: 🏖️
obsidianUIMode: preview
created: 2023-11-11T22:02
updated: 2023-11-13T19:25
---

# 1. zagger

- **AGENDA**
  - [今日笔记](obsidian://advanced-uri?vault=zagger&daily=true)
  - [每周笔记](obsidian://advanced-uri?vault=zagger&commandid=calendar%253Aopen-weekly-note)
  - [月度笔记]()
  - [周计划](https://www.kdocs.cn/l/cncngxEcagIY)
- **LIFE**
  - [[00. 图书馆|图书馆]]
  - [[秦某|个人主页]]
  - [[00. 文件管理|文件管理]]
...
- **WORK**
  ...
  - [[00. 工作|工作兼职]]
  - [[工作链接清单]]
  - [正则可视](https://wangwl.net/static/projects/visualRegex#source=Zint&match=1.1&method=match&prefix=Z)
- **专题**
  - [[引发的管理台项目可配置|远程总结]]
  - [[00.spice|spice]]
  - [[00. 英语学习|英语]]
  - [[typescript入门教程|typescript]]
- **集中汇总**
  - [[汇总所有在线文档|汇总]]
  - [[a 服务器相关命令|命令]]
  - [[obsidian清单]]
...
- **速记**
  - [[正则文章通读]]
  - [[vim使用技巧]]
  - [maps.vim](https://github.com/LinHQ1999/nvim-config/blob/office/mysettings/maps.vim)
  - [现代js文档](https://zh.javascript.info/keys-values-entries)
- **快捷方式**
  - [[每日网站打开]]
  - [[项目定制开发和远程|远程]]
  - [[shell脚本编写]]
  - [[ubuntu22.04安装|ubuntu]]
- **记事本**
...
- **快捷方式**
  - [[shell脚本编写]]
  - [[windows git bash 配置文件|gitBash]]
  - [[linux安装fnm]]
- **日常**
  - [[a docker实战 - 禅道卫士维护 2023.0606|禅道卫士维护]]
  - [[windows操作系统重装教程|windows]]
  - [[mmc]]
...
**Notes to display**
_Gets either notes in a folder or notes with a certain tag. Leave one of them empty._
sourceFolder::
sourceTag:: #project/open

**Notes to exclude**
_Leave empty to disable. Notes with the yaml-key `status` and value `exclude` for that key are also excluded.)_
excludeTag:: #exclude
...
_words or characters per page, depending on setting above. Set to zero to ignore._
wordsPerPage:: 350
charsPerPage:: 2000
...
**Longform Plugin**
_Leave empty to sort alphabetically. Enter the path to the index file of a longform project to order sections by their order in the longform plugin. (The `sourceFolder` setting further above has to be a Longform Drafts folder. )_
pathToIndexFile::

_Begin a filename with this character and it will be treated as subsection_
